...
if ( have_posts() ) :
    ...
    style="height:50vh;background:url(<?php echo get_the_post_thumbnail_url(); ?>)  center / cover no-repeat;"></div>
<?php } else {
...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-8">
            <h2 class="px-3 fs-2"><?php echo get_field('subtitle');?></h2>
            <div class="px-3 fs-5">
                <div>
                ...
                <div>
                    ...
                    <span>
                        ...
                        <i class="fa fa-phone text-warning" aria-hidden="true"></i><a
                            href="tel:<?php echo str_replace(' ', '', $phone); ?>"
                            class="text-decoration-none"><?php echo $phone; ?></a>
                        <?php endforeach; ?>
                    </span>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <a class="text-decoration-none"
                        href="tel:<?php echo $branchChief['phone'];  ?>"><?php echo $branchChief['phone']; ?></a>
                ...
                <div class="d-flex gap-4">
                    ...
                    <div>
                        <a href="tel:+56229259200" class="text-white text-decoration-none callcenter"><i
        ...
        <div class="col-12 border-top py-3 mt-5 fs-4">
            <?php the_content(); ?>
        </div>
