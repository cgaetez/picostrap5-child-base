<h1 class="text-center text-primary fw-bold pb-0 mb-0">
...
<div id="highlighted-carousel" class="carousel slide" data-bs-interval="false" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <?php while(have_rows('highlighted-carousel-slides')) : the_row(); ?>
      <button
        type="button"
  ...
  <div class="carousel-inner">
    <?php while(have_rows('highlighted-carousel-slides')) : the_row(); ?>
      <?php get_template_part("partials/main/highlighted-carousel/slide"); ?>
    <?php endwhile; ?>
  </div>

  <button type="button" class="carousel-control-prev" data-bs-target="#highlighted-carousel" data-bs-slide="prev" style="width: 3rem">
    <span class="carousel-control-prev-icon bg-warning p-4" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>

  <button type="button" class="carousel-control-next" data-bs-target="#highlighted-carousel" data-bs-slide="next" style="width: 3rem">
