...
if ( ! empty( $raq_data['raq_content'] ) ) : ?>
	...
	<h2 class="quote-title" style="margin-top:0px; margin-bottom:0px;">
		<?php
	...
	<table cellspacing="0" cellpadding="6"
		   style="width: 100%; border: 1px solid #eee;border-collapse: collapse;margin-bottom:5px">
		<thead>
		<tr>
		...
		foreach ( $raq_data['raq_content'] as $key => $item ) :
			...
			<tr>
				<td scope="col" class="td" style="<?php echo esc_attr( $product_name_style ); ?> padding:0px 10px;" >
					<?php
					if ( $show_image ) :
					...
					<a href="<?php echo esc_url( $_product->get_permalink() ); ?>" class="thumb-wrapper">
						...
						<div class="thumb-wrapper">
							...
							<!--<img
									...
									width="<?php //echo esc_attr( $dimensions[0] ); ?>" class="prueba2"/>-->
